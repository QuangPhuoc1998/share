...
uint8_t Ring_Buffer_Put(Ring_Buffer_t *handle, void *data, uint8_t len)
{
    uint8_t xreturn = 0;
...
uint8_t Ring_Buffer_Get(Ring_Buffer_t *handle, void *data, uint8_t len)
{
    uint8_t xreturn = 0;
    uint8_t *ptr = (uint8_t *)data;
		uint8_t index = 0;
...
{
    return Ring_Buffer_Put(handle, &data, 1);
}

uint8_t Ring_Buffer_Get_Char(Ring_Buffer_t *handle, uint8_t *data)
{
    return Ring_Buffer_Get(handle, data, 1);
}
